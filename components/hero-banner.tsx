export default function HeroBanner() {
  return (
    <section data-scroll-section className="snap-always snap-start relative isolate h-[100svh] min-h-[620px] overflow-hidden bg-[#b8c9cc] text-[#c94b28]" aria-labelledby="hero-title">
      <img className="absolute left-0 top-0 z-0 h-full w-full max-w-none" src="/assets/banner.jpg" alt="Phối cảnh BCONS Central Park tại Biên Hòa" fetchPriority="high" />
      ...
      {/* <div className="absolute left-1/2 top-[41%] z-10 w-[min(700px,80vw)] -translate-x-1/2 text-center font-serif text-[clamp(42px,4.2vw,69px)] font-bold leading-[1.05] tracking-[.015em] max-sm:top-[25%] max-sm:w-[90vw] max-sm:text-[clamp(34px,9vw,55px)]">
