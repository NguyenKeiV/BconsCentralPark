  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f1eee5] px-6 text-center text-[#294630]">
      <div>
        ...
        <a href="/" className="mt-8 inline-flex rounded-full bg-[#294630] px-6 py-3 text-sm font-semibold text-[#f1eee5] no-underline transition-colors hover:bg-[#c7922c]">Về trang chủ</a>
      </div>
    </main>
  );
}
