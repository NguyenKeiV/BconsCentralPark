...
export default function ScrollHeader() {
  ...
  return (
    <>
      ...
      <div id="main-menu" className={'fixed right-0 top-0 z-50 h-screen w-[min(430px,100%)] bg-[#294630] p-[120px_52px] text-white shadow-[-20px_0_60px_rgba(16,37,28,0.2)] transition-transform duration-500 max-sm:px-8 ' + (menuOpen ? 'translate-x-0' : 'translate-x-full')}>
