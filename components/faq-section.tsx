...
const faqs = [
  ...
  ['BCONS Central Park có những loại căn hộ nào?', 'Thông tin tổng quan hiện liệt kê các loại căn hộ Studio, 1PN, 2PN và 3PN. Diện tích, mã căn và bảng hàng cần được xác nhận theo tài liệu cập nhật.'],
