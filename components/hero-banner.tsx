...
export default function HeroBanner() {
  return (
    <section data-scroll-section className="snap-always snap-start relative isolate h-[100svh] min-h-[620px] overflow-hidden bg-[#b8c9cc] text-[#c94b28]" aria-labelledby="hero-title">
      <img className="absolute left-0 top-0 z-0 h-full w-full max-w-none object-cover object-center" src="/assets/banner.webp" alt="Phối cảnh BCONS Central Park tại Biên Hòa" fetchPriority="high" width="1600" height="960" />
