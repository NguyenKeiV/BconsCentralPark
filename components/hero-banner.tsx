  ...
  return (
    <section data-scroll-section className="snap-always snap-start relative isolate h-[100svh] min-h-[620px] overflow-hidden bg-[#b8c9cc] text-[#c94b28]" aria-labelledby="hero-title">
      ...
      <ScrollReveal className="absolute left-1/2 top-[41%] z-10 w-[min(700px,80vw)] -translate-x-1/2 text-center font-serif text-[clamp(42px,4.2vw,69px)] font-bold leading-[1.05] tracking-[.015em] text-[#d7b36a] [text-shadow:0_2px_18px_rgba(0,0,0,.3)] max-sm:top-[25%] max-sm:w-[90vw] max-sm:text-[clamp(34px,9vw,55px)]">
        <h1 data-reveal="title gold-flow" id="hero-title" className="m-0">Căn hộ chuẩn xanh<br />giữa lòng Biên Hòa</h1>
        <p data-reveal="details" className="mt-4 text-[14px] font-sans font-normal tracking-normal">BCONS Central Park tại phường Tam Hiệp, Biên Hòa</p>
      </ScrollReveal>
